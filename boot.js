define([], function() {
    ...
    return {
        boot: function(el, context, config, mediator) {
            ...
            // Load Main CSS
            addCSS('https://interactive.guim.co.uk/embed/labs/video-wall-template/assets-1472539756820/css/main.css');
            if ( DEBUG ){
            ...
            require(['https://interactive.guim.co.uk/embed/labs/video-wall-template/assets-1472539756820/js/main.js'], function(req){
